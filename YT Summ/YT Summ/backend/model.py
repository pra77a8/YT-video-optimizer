...
data = pd.read_csv(os.path.join(BASE_DIR, "dataset", "Youtube01.csv")) 
...
joblib.dump(model, os.path.join(BASE_DIR, 'spam_classifier.pkl'))
joblib.dump(cv, os.path.join(BASE_DIR, 'count_vectorizer.pkl'))